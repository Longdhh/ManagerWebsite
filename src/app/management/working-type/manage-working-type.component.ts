...
@Component({
  selector: 'app-manage-working-type',
  templateUrl: './manage-working-type.component.html',
  styleUrls: ['./manage-working-type.component.css']
})
export class ManageWorkingTypeComponent implements OnInit {
  ...
  showEdit(id: string) {
    this.service.get('/working-type/detail/' + id).subscribe((response: any) => {
      ...
      this.addEditForm.patchValue({
        workingType_id: this.workingType.workingType_id,
