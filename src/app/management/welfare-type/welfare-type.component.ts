...
@Component({
  selector: 'app-welfare-type',
  templateUrl: './welfare-type.component.html',
  styleUrls: ['./welfare-type.component.css']
})
export class WelfareTypeComponent implements OnInit {
